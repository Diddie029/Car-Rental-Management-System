...
<?php $sql = "SELECT tblvehicles.*,tblbrands.BrandName,tblbrands.id as bid  from tblvehicles join tblbrands on tblbrands.id=tblvehicles.VehiclesBrand ORDER BY tblvehicles.id DESC";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
...
{  ?>
        <div class="product-listing-m gray-bg">
          <div class="product-listing-img">
            <img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage1);?>" class="img-responsive" alt="<?php echo htmlentities($result->VehiclesTitle);?>" /> 
          </div>
          <div class="product-listing-content">
            <h5><a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>"><?php echo htmlentities($result->BrandName);?> - <?php echo htmlentities($result->VehiclesTitle);?></a></h5>
            <p class="list-price"><span class="price">$<?php echo htmlentities($result->PricePerDay);?></span> <span class="price-duration">Per Day</span></p>
            <ul>
      ...
      <?php }} 
          ...
          echo '<div class="alert alert-info" style="padding: 40px; text-align: center;"><i class="fa fa-car" style="font-size: 48px; color: #0066ff; margin-bottom: 20px;"></i><h3>No Vehicles Available</h3><p>There are currently no vehicles available. Please check back later or contact us for more information.</p></div>';
      }
      ?>
         </div>
